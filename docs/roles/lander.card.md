...
role; CLAUDE.md's seat table governs. Read `roles/COMMON.md` before `roles/LANDER.md`, the full
playbook.
...
The full rules are in `roles/LANDER.md`; read `roles/COMMON.md` first.
