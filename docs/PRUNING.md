...
2026-09-23 removing it left those commits on no ref. A name already in use gets the tip's short SHA
added, so a later worktree of the same name never overwrites an earlier keep-ref.
