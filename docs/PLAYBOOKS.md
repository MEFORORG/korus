...
| Builder | One brief, one turn. Takes the claim, builds, runs a code-review subagent, commits, pushes, reports with its QA line, exits. | [Builder](roles/builder.card.md) | `roles/BUILDER.md` |
