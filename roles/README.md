...
| **NARROWED 2026-09-18** | A Builder under a Manager pushes and reports; the **Manager** opens the PR and hands it to the Lander with five fields. Every other seat still opens its own. Since 2026-09-23, a session started from a chip counts as another seat, even when a Manager raised it: it is not a subagent. [MANAGER.md](MANAGER.md), *A session started from a chip opens its own pull request*. |
