...
**That holds when you run as the Manager's subagent. If you are in your own session -- a chip
started you, or the Manager spawned you -- open your own pull request** ([MANAGER.md](MANAGER.md),
